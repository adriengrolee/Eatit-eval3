...
add_action('wp_enqueue_scripts', function () {
  wp_enqueue_style( 'google_fonts', '//fonts.googleapis.com/css?family=Nunito+Sans:400,700&display=swap', true, null );
...
add_action('widgets_init', function () {
  ...
  register_sidebar([
    'name' => __('Zone pied de page', 'startheme') . ' ' . 4,
    'id'   => 'footer-sidebar-4'
  ] + $config);
});
...
add_filter('get_the_excerpt', function ($excerpt) {
  $excerpt_more = '<div class="more-link"><a class="btn btn-outline-primary" href="' . get_permalink() . '" >' . __( 'Lire la suite', 'startheme' ) . '</a></div>';
